...
export default function HoverUpCard({ icon: Icon, title, description, href }) {
  return (
    <>
      <a href={href}>
        <div className="bg-white rounded-2xl p-8  cursor-pointer flex flex-col gap-6  transition-all  hover:-translate-y-0.5  shadow-lg hover:shadow-lg duration-300 ">
          {/* Icon circle */}
          <div className="h-[50px] w-[50px] rounded-2xl bg-gray-100 flex items-center justify-center shrink-0">
